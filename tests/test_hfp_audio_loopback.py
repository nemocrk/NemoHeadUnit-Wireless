...
@pytest.mark.asyncio
async def test_mock_audio_adapter_hfp_loopback():
...
@pytest.mark.asyncio
async def test_linux_pulse_audio_hfp_loopback_activation_and_teardown():
...
@pytest.mark.asyncio
async def test_linux_pulse_audio_hfp_loopback_auto_discovery():
    adapter = LinuxPulseAudioAdapter()
    adapter._pactl_cmd = "/usr/bin/pactl"
